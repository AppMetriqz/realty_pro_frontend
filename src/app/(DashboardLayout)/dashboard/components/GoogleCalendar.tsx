      ...
      >
        ...
        >
          {usePageProps.isGoogleCalendarLogin ? (
            <>
              {usePageProps.googleCalendar.isSuccess &&
                usePageProps.googleCalendar.data.data.map((item, index) => {
                  return (
                    <Box
                      key={index}
                      display="flex"
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography
                          ...
                          fontWeight={400}
                        >
                          {DateTime.fromISO(item.start).toFormat('MMM, EEE')}
                        </Typography>
                        ...
                        <Typography
                          ...
                          fontWeight={400}
                        >
                          {DateTime.fromISO(item.start).toFormat('hh:mma')} -{' '}
                          {DateTime.fromISO(item.end).toFormat('hh:mma')}
                        </Typography>
            ...
            >
              {usePageProps.isLoadingCalendar ? (
                <CircularProgress size={40} />
              ) : (
                <Button
                  sx={{ marginLeft: '50px' }}
                  fullWidth
                  disabled={usePageProps.isLoadingCalendar}
