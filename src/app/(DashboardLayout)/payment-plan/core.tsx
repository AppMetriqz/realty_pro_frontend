...
export const HeadCellsPaymentPlan: Array<ColumnProps<PaymentPlanDto>> = [
    ...
    },
    {
        ...
        disablePadding: true,
        label: 'Monto',
        render: (_, record: Partial<PaymentPlanDto>) => (record.project?.currency_type ?? "") + (getPendingPayment(record)),
    },
    {
        key: 'project',
        numeric: false,
...
export const HeadCellsPaymentPlanFinancing: Array<ColumnProps<PaymentPlanDto>> = [
    {
        ...
        disablePadding: true,
        label: 'ID',
        render: (_, record: Partial<PaymentPlanDto>) => record.payment_plan_id??0,
    },
    {
        key: 'remaining_time',
        numeric: false,
    ...
    },
    {
        ...
        disablePadding: true,
        label: 'Monto',
        render: (_, record: Partial<PaymentPlanDto>) => (record.project?.currency_type ?? "") + (formatter.format(record.total_amount_paid??0)),
    },
    {
        key: 'project',
        numeric: false,
